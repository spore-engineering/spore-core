...
* spore.conf: contains configuration settings for spored or spore-qt
* spored.pid: stores the process id of spored while running
...
* debug.log: contains debug information and general logging generated by spored or spore-qt
