...
"""Verify that starting spore with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start spore with -h for help text")
        ...
        self.log.info("Start spore with -version for version information")
        ...
        self.log.info("Start spored with -fakearg to make sure it does not start")
