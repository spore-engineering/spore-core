...
const char * const BITCOIN_CONF_FILENAME = "spore.conf";
const char * const BITCOIN_PID_FILENAME = "spore.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Spore";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Spore";
#else
    // Unix
    return pathRet / ".spore";
#endif
#endif
}
