...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " spore-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  spore-tx [options] <hex-tx> [commands]  Update hex-encoded spore transaction\n" +
            "or:     spore-tx [options] -create [commands]   Create hex-encoded spore transaction\n" +
            "\n";
